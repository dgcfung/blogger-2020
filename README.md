...
Note: This repo was corrupted after pull down of previous commit. I attempted the "git revert" command but was unsuccessful in restoring repo. I created a new repo to continue working. 

Link to new repo(working code): https://git.generalassemb.ly/dgcfung/blogger-2020-backup
